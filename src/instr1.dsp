...
//================================================================================================================
mappingQfilter7(secCounter) = movingAverageRMS(.5)*20: *(200):  _+200 : _ ,1000 : min : peakHolder(3) : integrator(0.3);
...
scaleFreq = hslider("freq SCALER", 0.2, 0.1, 0.4, 0.01): si.smoo;
timeReverb = hslider("time reverb", 3, 1, 4, 0.01): si.smoo;
lfoFreq = hslider("freq LFO", 1, .2, 10, 0.01): si.smoo;
//============================
inGain =hslider("[0]gain In", 1, 0, 4, 0.01): si.smoo;
gainReverb = hslider("gain Rev", 0.11, 0, 1, 0.001): si.smoo;

smistatoreChord(amp, in) = in, si.bus(6) : chord2(mappingQfilter7(1.5),noiseFbkBank2(fDev,scaleFreq,0.01,0.5), degI1,makeMidSide,timeReverb,funtSec,gainReverb);
...
smistatoreSeq(amp) = sequencer2(mappingQfilter6(1.5),noiseFbkBank2(fDev,scaleFreq,.02,0.43),chooser,degI1,makeMidSide, timeReverb,.3) ;
